        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-3 col-md-6">
                    <div class="footer_widget"id="#about">
                       <h4 style="color:orange;">About Venus</h4 >
                        <p>
                ...
                <div class="col-lg-3 col-md-6">
            	 ...
            	 <p>
                           Email:  venusrestaurant@gmail.com
				</p>
                            <p>
                           Tel: 0700 000 000  
                        </p>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="footer_widget">
                        ...
                        <ul class="opening_time">
                            <li>Monday - Friday 8:00am - 23:00pm</li>
